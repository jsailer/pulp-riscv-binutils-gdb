...
#define MATCH_TAGSET 0x6b
#define MASK_TAGSET  0x707f
#define MATCH_TAGRD 0x106b
#define MASK_TAGRD  0x707f
...
DECLARE_INSN(tagset, MATCH_TAGSET, MASK_TAGSET)
DECLARE_INSN(tagrd, MATCH_TAGRD, MASK_TAGRD)
