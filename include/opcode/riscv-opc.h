...
#define MATCH_SETPC 0x77
#define MASK_SETPC  0xffffffff
#define MATCH_SETPCLABEL 0xf7
#define MASK_SETPCLABEL  0xfff
#define MATCH_CHECKPC 0x177
#define MASK_CHECKPC  0xffffffff
#define MATCH_CHECKLABEL 0x1f7
#define MASK_CHECKLABEL  0xfff
#define MATCH_LJCFI 0x277
#define MASK_LJCFI  0xffffffff
#define MATCH_SJCFI 0x2f7
#define MASK_SJCFI  0xfff
#define MATCH_CFIBR 0x377
#define MASK_CFIBR  0xfff
#define MATCH_CFIRET 0x3f7
#define MASK_CFIRET  0xfff
#define MATCH_CFIPRJ 0x477
#define MASK_CFIPRJ  0xfff
#define MATCH_CFIPRC 0x4f7
#define MASK_CFIPRC  0xfff
#define MATCH_CFICHK 0x577
#define MASK_CFICHK  0xfff
#define MATCH_CFIDEL 0x5f7
#define MASK_CFIDEL  0xfff
#define MATCH_CFIREC 0x677
#define MASK_CFIREC  0xfff
...
#define MASK_CFIMATLDCALLEE  0xfff
#define MATCH_CFICALL_I 0x8f7
#define MASK_CFICALL_I  0xfff
#define MATCH_CFIJUMP_I 0x977
#define MASK_CFIJUMP_I  0xfff
#define MATCH_CFICHECK 0x9f7
#define MASK_CFICHECK  0xfff
...
#define MASK_CFI_DBG_RST_CNT  0xfffff07f
#define MATCH_CFI_DBG1 0x106b
#define MASK_CFI_DBG1  0xfffff07f
#define MATCH_CFI_DBG2 0x206b
#define MASK_CFI_DBG2  0xfffff07f
#define MATCH_CFI_DBG3 0x306b
#define MASK_CFI_DBG3  0xfffff07f
#define MATCH_CFI_DBG4 0x406b
#define MASK_CFI_DBG4  0xfffff07f
#define MATCH_CFI_RESET 0x506b
#define MASK_CFI_RESET  0xffffffff
#define MATCH_CFI_ENABLE 0x606b
#define MASK_CFI_ENABLE  0xffffffff
#define MATCH_CFI_DISABLE 0x706b
#define MASK_CFI_DISABLE  0xffffffff
...
DECLARE_INSN(setpc, MATCH_SETPC, MASK_SETPC)
DECLARE_INSN(setpclabel, MATCH_SETPCLABEL, MASK_SETPCLABEL)
DECLARE_INSN(checkpc, MATCH_CHECKPC, MASK_CHECKPC)
DECLARE_INSN(checklabel, MATCH_CHECKLABEL, MASK_CHECKLABEL)
DECLARE_INSN(ljcfi, MATCH_LJCFI, MASK_LJCFI)
DECLARE_INSN(sjcfi, MATCH_SJCFI, MASK_SJCFI)
DECLARE_INSN(cfibr, MATCH_CFIBR, MASK_CFIBR)
DECLARE_INSN(cfiret, MATCH_CFIRET, MASK_CFIRET)
DECLARE_INSN(cfiprj, MATCH_CFIPRJ, MASK_CFIPRJ)
DECLARE_INSN(cfiprc, MATCH_CFIPRC, MASK_CFIPRC)
DECLARE_INSN(cfichk, MATCH_CFICHK, MASK_CFICHK)
DECLARE_INSN(cfidel, MATCH_CFIDEL, MASK_CFIDEL)
DECLARE_INSN(cfirec, MATCH_CFIREC, MASK_CFIREC)
DECLARE_INSN(cficall, MATCH_CFICALL, MASK_CFICALL)
DECLARE_INSN(cfifwd, MATCH_CFIFWD, MASK_CFIFWD)
DECLARE_INSN(cfimatldcaller, MATCH_CFIMATLDCALLER, MASK_CFIMATLDCALLER)
DECLARE_INSN(cfimatldcallee, MATCH_CFIMATLDCALLEE, MASK_CFIMATLDCALLEE)
DECLARE_INSN(cficall_i, MATCH_CFICALL_I, MASK_CFICALL_I)
DECLARE_INSN(cfijump_i, MATCH_CFIJUMP_I, MASK_CFIJUMP_I)
DECLARE_INSN(cficheck, MATCH_CFICHECK, MASK_CFICHECK)
DECLARE_INSN(cfisetjmp, MATCH_CFISETJMP, MASK_CFISETJMP)
DECLARE_INSN(cfilongjmp, MATCH_CFILONGJMP, MASK_CFILONGJMP)
DECLARE_INSN(cfiendbranch, MATCH_CFIENDBRANCH, MASK_CFIENDBRANCH)
DECLARE_INSN(CFI_DBG_RST_CNT, MATCH_CFI_DBG_RST_CNT, MASK_CFI_DBG_RST_CNT)
DECLARE_INSN(CFI_DBG1, MATCH_CFI_DBG1, MASK_CFI_DBG1)
DECLARE_INSN(CFI_DBG2, MATCH_CFI_DBG2, MASK_CFI_DBG2)
DECLARE_INSN(CFI_DBG3, MATCH_CFI_DBG3, MASK_CFI_DBG3)
DECLARE_INSN(CFI_DBG4, MATCH_CFI_DBG4, MASK_CFI_DBG4)
DECLARE_INSN(CFI_RESET, MATCH_CFI_RESET, MASK_CFI_RESET)
DECLARE_INSN(CFI_ENABLE, MATCH_CFI_ENABLE, MASK_CFI_ENABLE)
DECLARE_INSN(CFI_DISABLE, MATCH_CFI_DISABLE, MASK_CFI_DISABLE)
